            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                <p className="text-sm text-gray-500 dark:text-gray-500">
                  In the meantime, feel free to check out my other projects on the <a href="/" className="text-blue-600 dark:text-blue-400 hover:underline">main page</a> or learn more <a href="/about-me" className="text-blue-600 dark:text-blue-400 hover:underline">about me</a>.
                </p>
              </div>
            </div>
          </Card>
