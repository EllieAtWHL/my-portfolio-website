...
import { getTeamById, getMatchesForTeam, getPlayersForTeam, TeamPlayers } from '@/lib/data/teams';
...
export default function TeamPage({ params }: PageProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const [data, matches, players] = await Promise.all([
        getTeamById(teamId),
