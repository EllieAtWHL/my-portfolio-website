...
export function getTeamColor(colorName?: string): string {
  ...
  const colorMap: Record<string, string> = {
    ...
    'yellow-400': '#fbbf24', 'yellow-500': '#eab308', 'yellow-600': '#ca8a04', 'yellow-700': '#a16207',
    ...
    // Additional variants for other colors
